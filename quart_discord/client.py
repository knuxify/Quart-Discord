...
class DiscordOAuth2Session(_http.DiscordOAuth2HttpClient):
    ...
    async def create_session(
        ...
        permissions: typing.Union[quart_discord.types.Permissions, int], optional
        ...
        if "bot" in scope:
            if not isinstance(permissions, (types.Permissions, int)):
                raise ValueError(f"Passed permissions must be an int or quart_discord.types.Permissions, not {type(permissions)}.")
